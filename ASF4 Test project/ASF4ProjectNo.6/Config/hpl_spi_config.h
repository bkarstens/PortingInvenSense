...
#if CONF_FLEXCOM5_CK_SRC > 0
#warning For clock source must be Master Clock(MCK)
#endif
...
#define CONF_SPI_5_ENABLE 1
#endif

// Set module in SPI Master mode
#ifndef CONF_SPI_5_MODE
#define CONF_SPI_5_MODE 0x01
#endif

// Set FIFO disable
#ifndef CONF_SPI_5_FIFO_DISABLE
#define CONF_SPI_5_FIFO_DISABLE 0x01
#endif

// Set peripheral select as fixed
#ifndef CONF_SPI_5_PS
#define CONF_SPI_5_PS 0x0
#endif

// Set chip select decode as directly
#ifndef CONF_SPI_5_PCSDEC
#define CONF_SPI_5_PCSDEC 0x0
#endif
...
#ifndef CONF_SPI_5_CHSIZE
#define CONF_SPI_5_CHSIZE 0x0
#endif

// <o> Baud rate <1-40000000>
// <i> The SPI data transfer rate. Note: (fspi_clock / baudrate) < 255
// <id> spi_master_baud_rate
#ifndef CONF_SPI_5_BAUD
#define CONF_SPI_5_BAUD 6000000
#endif
...
#ifndef CONF_SPI_5_DUMMYBYTE
#define CONF_SPI_5_DUMMYBYTE 0xffff
#endif
...
#ifndef CONF_SPI_5_CPOL
#define CONF_SPI_5_CPOL 0x0
#endif
...
#ifndef CONF_SPI_5_NCPHA
#define CONF_SPI_5_NCPHA 0x1
#endif
...
#define CONF_SPI_5_DLY_SPCK 0x40
#endif
...
#define CONF_SPI_5_DLY_BCT 0x01
#endif

// </e>

/* Calculate baud register value from requested baudrate value */
#ifndef CONF_SPI_5_BAUD_RATE
#define CONF_SPI_5_BAUD_RATE (CONF_FLEXCOM5_FREQUENCY / CONF_SPI_5_BAUD)
#endif
